...
const PricingOffer = () => {
  ...
  // Competitors charge 2.5% flat
  // Zwitch charges 1.55% for the first 1 Cr annually, and 1.9% for the rest
  const annualVolume = volume * 12;
  const competitorAnnualFee = annualVolume * 0.025;

  const zwitchTier1Limit = 10000000; // 1 Crore
  const zwitchTier1Rate = 0.0155;
  const zwitchTier2Rate = 0.019;

  const zwitchTier1Volume = Math.min(annualVolume, zwitchTier1Limit);
  const zwitchTier2Volume = Math.max(0, annualVolume - zwitchTier1Limit);

  const zwitchAnnualFee = (zwitchTier1Volume * zwitchTier1Rate) + (zwitchTier2Volume * zwitchTier2Rate);
  const annualSavings = competitorAnnualFee - zwitchAnnualFee;
          ...
          <div className="md:hidden max-w-3xl mx-auto">
            ...
            <div className="text-left mb-6">
              <h2 className="font-display font-bold text-[24px] mb-2">
                Flat <span className="gradient-text">1.55%*</span> Transaction Fee
              </h2>
              <p className="text-sm text-muted-foreground">
                Most gateways charge 2–3%. Lock in 1.55%* today.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-border bg-card/50 p-4 mb-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-2xl font-display font-bold gradient-text">1.55%*</p>
                </div>
              </div>
            </div>
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                trackRegisterClick("pricing_mobile", "Lock 1.55%* Pricing");
            ...
            >
              <div className="grid md:grid-cols-3 gap-6 text-center">
                ...
                <div className="p-4 bg-primary/10 rounded-lg border border-primary/30">
                  ...
                  <p className="text-4xl font-display font-bold gradient-text">1.55%*</p>
                </div>
                <div className="p-4">
              ...
              <div className="grid md:grid-cols-2 gap-10 items-start">
                <div>
                  ...
                  <a
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      trackRegisterClick("pricing_desktop", "Claim 1.55%* Rate Now");
